...
var keyboard_mode: boolean = false;
var keyboard_shift: boolean = false;
...
fetch(chrome.runtime.getURL("keyboard.html"))
    ...
    .then(() => {
        ...
        const input = document.getElementById("keyboard-input") as HTMLInputElement;
        var targetInput: HTMLInputElement = undefined;
        ...
        document.addEventListener(
            ...
            (event) => {
                ...
                if (
                    ...
                    if (!keyboard.classList.contains("active")) keyboard.classList.add("active");
        ...
        document.getElementById("keyboard-clear").addEventListener(
            "click",
            () => {
                if (targetInput) {
